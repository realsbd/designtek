...
export default function Sidebar(){
    ...
    return (
        <>
            {open ?
                <aside className={`bg-gray-800 min-h-screen max-md:fixed z-40 w-64 py-4 px-6 transition-transform duration-300 `}>
                ...
                <button className={`fixed md:block px-2 text-gray-500 hover:text-black focus:outline-none`} onClick={() => setOpen(!open)}>
