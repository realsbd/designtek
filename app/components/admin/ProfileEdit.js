...
const ProfileEdit = ({ setScroll }) => {
  ...
  const [confirmField, setConfirmField] = useState(null); // Track the field to confirm
  ...
  const handleFieldEditClick = (fieldName) => {
            ...
            <div className="flex flex-col-reverse md:flex-row gap-10 lg:gap-[100px] mt-7">
              ...
              <div className="w-full flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="firstname"
                    // onClick={() => handleFieldEditClick("firstname")}
                  >
                    First Name
                  </label>
                  <div className="input-field">
                    <input
                      ...
                      id="firstname"
                      ref={firstNameRef}
                      onFocus={() => handleFieldEditClick("firstname")}
                      className="w-full rounded border-2 text-sm focus:outline-primary-green border-solid border-gray-300 px-3 py-[8px]"
                    ></input>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="input-field">
                    <input
                      ...
                      id="lastname"
                      ref={lastNameRef}
                      onFocus={() => handleFieldEditClick("lastname")}
                      className="w-full rounded border-2 text-sm focus:outline-primary-green border-solid border-gray-300 px-3 py-[8px]"
                    ></input>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="input-field">
                    <input
                      ...
                      id="username"
                      ref={userNameRef}
                      onFocus={() => handleFieldEditClick("username")}
                      className="w-full rounded border-2 text-sm focus:outline-primary-green border-solid border-gray-300 px-3 py-[8px]"
                    ></input>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="input-field">
                    <input
                      ...
                      id="displayname"
                      ref={displayNameRef}
                      onFocus={() => handleFieldEditClick("displayname")}
                      className="w-full rounded border-2 text-sm focus:outline-primary-green border-solid border-gray-300 px-3 py-[8px]"
                    ></input>
                  </div>
                </div>
