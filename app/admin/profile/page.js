...
const ProfilePage = () => {
  ...
  return (
    <div>
      {showConfirmEdit && (
        <div className="fixed z-50 top-0 right-0 left-0 w-full screen_height">
          <ConfirmEdit onClose={handleCloseConfirmEdit} />
        </div>
      )}
      <div className="pt-10 px-10 md:px-[100px] pb-[100px]">
          ...
          <form className="w-full">
            ...
            <div className="flex flex-col md:flex-row gap-10 lg:gap-[100px] mt-7">
              <div className="w-full flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="password1">Enter old password</label>
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="password2">Enter new password</label>
                  <div className="input-field">
                    <input
                      type="password"
                      id="password2"
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="password3">Re-enter new password</label>
                  <div className="input-field">
                    <input
                      type="password"
                      id="password3"
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="status">2FA Status</label>
                  <div className="input-field">
                    <input
                      type="text"
                      id="status"
              ...
              <div className="w-full flex flex-col gap-4">
                {/* second part */}
                <div className="flex flex-col gap-2">
                  <label htmFor="password1" onClick={handleRoleDropdownClick}>
                    Role
                  </label>
                  <div className="input-field">
                    <select className="w-full rounded border-2 text-sm focus:outline-primary-green border-solid border-gray-300 px-3 py-[8px]">
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="username">User Name</label>
                  <div className="input-field">
                    <input
                      type="text"
                      id="username"
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="displayname">Displayed Name</label>
                  <div className="input-field">
                    <input
                      type="text"
                      id="displayname"
            ...
            <div className="flex flex-col md:flex-row gap-10 lg:gap-[100px] mt-7">
              ...
              <div className="w-full flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <label htmFor="website">Website</label>
                  <div className="input-field">
                    <input
                      type="text"
                      id="website"
            ...
            <div className="w-full flex flex-col gap-4">
              {/* first part */}
              <div className="flex flex-col gap-2">
                <label htmFor="biography">Biography Information</label>
                <div className="input-field">
                  <textarea
                    id="biography"
