        ...
        <AuthLayout>
            <div className="mx-auto">
                ...
                <form>
                    ...
                    <button className="login-button w-full bg-gray-300 rounded py-2 my-3">Sign up</button>
                </form>
                <div className="form-footer">
                    <p>Already have an account? <span className="text-indigo-500"><Link href="/login">Log in</Link></span></p>
                </div>
            </div>
        </AuthLayout>
    )
