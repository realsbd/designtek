        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-justify">
              ...
              (the &quot;Service&quot;) and that you will abide by them. Use of
              our Service is prohibited if you disagree with these Terms.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-justify">
              4.3 You are solely responsible for the content you publish on our
              platform. We reserve the right to remove any content that violates
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-justify">
              ...
              You agree to the updated Terms if you keep using the Service after
