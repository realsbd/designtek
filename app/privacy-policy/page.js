  ...
  return (
    <section className="py-10 md:px-24">
      ...
      <main className="px-4 md:px-16">
        <h1 className="text-2xl text-center my-4">Privacy Policy: Blog</h1>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="pl-7 list-disc text-justify">
              ...
              <li>Other information relevant to user surveys and/or offers</li>
            </ul>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-justify">
              ...
              your mind at any time by contacting us.
            </p>
          </div>
